...
export const BookCard: React.FC<BookCardProps> = ({ book, onClick, viewMode = 'grid', mastery }) => {
    ...
    return (
      ...
      >
        <div className="p-4 md:p-6 flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
          ...
          <div className="flex items-center justify-end gap-3 md:gap-4 md:w-auto mt-1 md:mt-0">
  ...
  return (
    <div 
      onClick={() => onClick(book)}
      className={`${baseClasses} hover:-translate-y-1 flex flex-col`}
    >
